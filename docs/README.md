...
- [BACKLOG.md](./planning/BACKLOG.md) — текущие приоритеты и [этапы разработки по повторному аудиту](./planning/BACKLOG.md#план-разработки-по-повторному-аудиту-10-сентября-2026-года).
