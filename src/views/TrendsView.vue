  ...
  <section class="page page--review page--trends">
    ...
    <template v-else>
      ...
      <article class="dashboard-card dashboard-card--quality">
        ...
        <p class="data-note">
          «Основные поля» означают, что заполнены хотя бы два блока: состояние, действия или питание. Карта нужна только для оценки
          надёжности выводов.
        </p>
      </article>
        ...
        <template v-if="eventComparison">
          <div class="comparison-periods">
            ...
            <span
              ...
              {{ eventComparison.afterEntries }}/{{ eventComparison.windowDays }}</span
            >
          </div>
