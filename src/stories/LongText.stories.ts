...
export const LongInsight: Story = {
  ...
  args: {
    modelValue: 'После нескольких недель заметил, что сложные решения легче принимать не сразу после напряжённого дня, а после прогулки и сна. Это пока наблюдение, а не доказанная причина. Хочу проверить, повторяется ли оно в следующие недели и не связано ли с другими изменениями режима.',
    rows: 4,
    maxLength: 2000,
  },
};
